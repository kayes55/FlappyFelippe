...
public extension CGFloat {
 ...
 func radiansToDegrees() -> CGFloat {
   ...
   */
//MARK:- There was a warning stated '4294967295' is not exactly representable as 'Float'; it becomes '4294967296'. solution is here: https://stackoverflow.com/questions/55414083/need-explanation-about-random-function-swift
...
public func shortestAngleBetween(angle1: CGFloat, angle2: CGFloat) -> CGFloat {
    ...
    // this below line shows this error message: % is unavailable use truncate remainder instead
